...
const HeroSlider = ({ onSearch }) => {
  ...
  return (
    <div className="relative h-[85vh] w-full flex items-center justify-center overflow-hidden bg-gray-900 font-sans">
      ...
      {/* Content Container */}
      <div className="relative z-[100] w-full max-w-5xl px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        <h1 className="text-5xl md:text-7xl lg:text-[4.5rem] font-black text-white mb-6 tracking-tight font-sans drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-bottom-8 duration-[1200ms]">
        ...
        <p className="text-xl md:text-2xl text-white/95 mb-14 max-w-3xl mx-auto font-semibold drop-shadow-lg leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-[1200ms] delay-200 fill-mode-both">
          Craving something delicious? Discover the best restaurants and dishes delivered straight to your door.
        </p>
        ...
        <form 
          ...
          className="w-full max-w-4xl mx-auto group animate-in fade-in slide-in-from-bottom-8 duration-[1200ms] delay-300 fill-mode-both relative z-[101]"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center w-full bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-full shadow-[0_12px_45px_rgba(0,0,0,0.25)] border-2 border-white/60 focus-within:border-warmOrange focus-within:shadow-[0_12px_45px_rgba(249,115,22,0.25)] transition-all duration-300 overflow-visible relative">
            ...
            <div className="flex items-center w-full sm:w-[45%] px-6 py-3 sm:py-4 border-b sm:border-b-0 sm:border-r border-gray-200/60 bg-transparent relative">
              ...
              {locationError && (
                <div className="absolute top-full left-4 mt-2 z-[100] animate-in fade-in slide-in-from-top-2 duration-300 w-[max-content] max-w-[280px]">
        ...
        {heroImages.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all duration-500 ${
              index === currentSlide ? 'bg-warmOrange w-8 opacity-100' : 'bg-white/50 hover:bg-white w-2 opacity-70'
            }`}
